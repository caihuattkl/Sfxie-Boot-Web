...
$.extend($.fn, {
    initJerichoTab: function(setting) {
        ...
        $.fn.jerichoTab.resize = function() {
            ...
            //	fixHeight = 25;
            //}
            var _$h = $(document).height();
            var _$height = _$h - $('#navbar').height() - 20;

            console.log(_$height);
            $('#jerichotab_contentholder').height(_$height - opts.titleHeight - 5 - fixHeight);
            $(".jericho_tab iframe").height(_$height - opts.titleHeight - fixHeight);
        };
    ...
    buildIFrame: function(src) {
        return this.each(function() {
            ...
            var iframe = $('<iframe id="' + jerichotabiframe + '" name="' + jerichotabiframe + '" src="' + src + '" frameborder="0" scrolling="auto" />')
							.css({ width: '100%', height: _$height , border: 0 }).appendTo($(this));
